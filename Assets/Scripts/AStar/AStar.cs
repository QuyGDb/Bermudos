...
//    /// </summary>
//    public static Stack<Vector3> BuildPath(Map map, Vector3Int startGridPosition, Vector3Int endGridPosition)
//    {
//        // Adjust positions by lower bounds
//        startGridPosition -= (Vector3Int)map.templateLowerBounds; ;
//        endGridPosition -= (Vector3Int)map.templateLowerBounds;
...
//        GridNodes gridNodes = new GridNodes(map.templateUpperBounds.x - map.templateLowerBounds.x + 1, map.templateUpperBounds.y - map.templateLowerBounds.y + 1);
...
//            Vector3 worldPosition = room.instantiatedRoom.grid.CellToWorld(new Vector3Int(nextNode.gridPosition.x + map.templateLowerBounds.x, nextNode.gridPosition.y + map.templateLowerBounds.y, 0));
